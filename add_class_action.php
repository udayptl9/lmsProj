...
// $query = mysqli_query($conn,"select * from teacher_class where department_id=$department_id subject_id = $subject_id and class_id = $class_id and teacher_id = $session_id and school_year = $school_year ")or die(mysqli_error($query));
// $count = mysqli_num_rows($query);
// if ($count > 0){ 
//     echo "true";
// }else{
mysqli_query($conn,"insert into teacher_class (teacher_id,subject_id,class_id,thumbnails,school_year,department_id) values('$session_id','$subject_id','$class_id','admin/uploads/thumbnails.jpg','$school_year','$department_id')")or die(mysqli_error());
