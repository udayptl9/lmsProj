...
<div id='sidebarMini' class='span3'> 
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class="active"><a title="Notification" href="notification_teacher.php" style='position: relative;'><i class="icon-info-sign"></i>
		...
		<li class=""><a title="Messages" href="teacher_message.php"><i class="icon-envelope-alt"></i></a></li> 
