...
<div id='sidebarMini' class='span3'> 
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class=""><a title="My Students" href="my_students.php<?php echo '?id='.$get_id; ?>"></i><i class="icon-group"></i>&nbsp;</a></li>
				<li class="active"><a title="Attendence" href="attendence.php<?php echo '?id='.$get_id; ?>"></i><i class="icon-group"></i>&nbsp;</a></li>
...
<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				...
				<li class="active"><a href="attendence.php<?php echo '?id='.$get_id; ?>"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Attendence</a></li>
